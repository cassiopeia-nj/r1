...
% %Tc
% figure(1)
% plot(iniBer,TcB,'p-',iniBer,TcC,'h-',iniBer,Tc0,'x-',iniBer,Tc1,'s-',iniBer,Tc2,'d-',iniBer,Tc3,'*-');
% title('Tc');
% legend('BBBSS','CASCADE','TURBO00','TURBO01','TURBO10','TURBO11');
% 
% %Td
% figure(2)
% plot(iniBer,TdB,'p-',iniBer,TdC,'h-',iniBer,Td0,'x-',iniBer,Td1,'s-',iniBer,Td2,'d-',iniBer,Td3,'*-');
% title('Td');
% legend('BBBSS','CASCADE','TURBO00','TURBO01','TURBO10','TURBO11');
% 
% %success rate
...
%crei
figure(4)
plot(iniBer,creiB,'p-',iniBer,creiC,'h-',iniBer,crei0,'x-',iniBer,crei1,'s-',iniBer,crei2,'d-',iniBer,crei3,'*-');
